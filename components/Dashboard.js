      ...
      <header className="p-6 bg-darkPurple flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11c0-1.104-.896-2-2-2h-4c-1.104 0-2 .896-2 2v3.158a2.032 2.032 0 01-.595 1.437L7 17h5m0 0v2a2 2 0 11-4 0v-2m4 0a2 2 0 104 0v-2"></path></svg>
          </div>
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-darkPurple p-4 flex justify-around">
        {[
          ...
          <button key={item.name} className="flex flex-col items-center">
            <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={`M${item.icon}`}></path></svg>
